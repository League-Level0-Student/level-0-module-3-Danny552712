...
public class ShinyObjects {
	...
	void manyShinyObjects() {
		...
		String userShiny = JOptionPane.showInputDialog(null, "How many shiny objects do you want?");
		int userIntShiny = Integer.parseInt(userShiny);
		// 3. Play the sound that many times
		for(int i = 0; i < userIntShiny; i++) {
			playMisterZee();
		}
